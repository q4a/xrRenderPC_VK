...
{
    _set(frontend.resources_->Create(s_shader, s_textures, s_constants, s_matrices));
}
void resptrcode_shader::create(IBlender* B, LPCSTR s_shader, LPCSTR s_textures, LPCSTR s_constants, LPCSTR s_matrices)
{
    _set(frontend.resources_->Create(B, s_shader, s_textures, s_constants, s_matrices));
}
